import { getProp, isArray, isFunction, isNil, isString } from "./utils/common";
...
export default {
  methods: {
    ...
    getFieldRowClasses(field) {
      ...
      let baseClasses = {
        [getProp(this.options, "validationErrorClass", "error")]: hasErrors,
        [getProp(this.options, "validationSuccessClass", "valid")]: !hasErrors,
